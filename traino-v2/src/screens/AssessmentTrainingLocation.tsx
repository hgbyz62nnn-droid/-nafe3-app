...
export default function AssessmentTrainingLocation() {
  const [selected, setSelected] = useState<Set<string>>(new Set(['gym']));
  ...
  return (
    <Screen withNav={false} className="pb-8">
      <StatusBar />
      <OnboardingHeader title="Assessment" progress={3 / 8} />

      <div className="px-5 mt-4">
        <p className="text-text-secondary text-[12px] font-semibold">Step 3 of 8</p>
