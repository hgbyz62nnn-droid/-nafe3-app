...
// عضلات ثانوية - نفس فكرة الأعمدة اللي فوق بالظبط، لكن القيمة قايمة JSON
// (أسماء عضلات من نفس مجموعة muscle_group الموجودة) مش نص مفرد، عشان
// تمرين ممكن يشتغل على أكتر من عضلة ثانوية في نفس الوقت.
try { db.exec("ALTER TABLE exercises ADD COLUMN secondary_muscles TEXT NOT NULL DEFAULT '[]'"); } catch (e) {}
...
// العنصر الرابع (secondary_muscles) - عضلات ثانوية معروفة تشريحيًا لكل
// تمرين (مش أرقام مخترعة)، من نفس مجموعة muscle_group الموجودة أصلًا
// (chest/back/legs/shoulders/arms/core/cardio)، من غير تكرار العضلة
// الأساسية بتاعت التمرين نفسه.
const EXERCISE_CLASSIFICATIONS = {
  'بنش برس بار': ['compound', 'push', 'استلقِ على البنش، أمسك البار بعرض أوسع من الكتف قليلًا، وانزله للصدر ثم ادفعه لأعلى بثبات.', ['shoulders', 'arms']],
  'بنش برس دمبل': ['compound', 'push', 'استلقِ على البنش ممسكًا دمبلين عند الصدر، وادفعهم لأعلى حتى تمديد شبه كامل للذراعين.', ['shoulders', 'arms']],
  'بنش برس مايل بار': ['compound', 'push', 'زي البنش برس العادي بس على بنش مائل 30-45 درجة لتركيز أكبر على أعلى الصدر.', ['shoulders', 'arms']],
  'بنش برس مايل دمبل': ['compound', 'push', 'دمبلين على بنش مائل، انزلهم لجانبي أعلى الصدر وادفعهم لأعلى مع تحكم.', ['shoulders', 'arms']],
  'تفتيح دمبل': ['isolation', 'push', 'استلقِ ممسكًا دمبلين فوق الصدر بمرفقين مثنيين قليلًا، وافتحهم للجانبين ثم ارجع لنقطة البداية.', ['shoulders']],
  'كابل كروس أوفر': ['isolation', 'push', 'واقف بين بكرتين، اجذب المقابض لبعضهم أمام الصدر مع الحفاظ على انحناءة بسيطة في المرفق.', ['shoulders']],
  'بار متوازي (تريسبس/صدر)': ['compound', 'push', 'على البار المتوازي، انزل جسمك بميل للأمام لتركيز الصدر وادفع لأعلى.', ['arms', 'shoulders']],
  'بوش أب': ['compound', 'push', 'وضع البلانك، انزل الصدر نحو الأرض بمرفقين قريبين من الجسم وادفع لأعلى.', ['shoulders', 'arms', 'core']],
  'بك سكوات': ['compound', 'squat', 'البار على أعلى الظهر، انزل الحوض للخلف والأسفل مع إبقاء الصدر مرفوع، ثم اقف.', ['core', 'back']],
  'فرونت سكوات': ['compound', 'squat', 'البار على مقدمة الأكتاف، انزل بوضعية مستقيمة أكثر من السكوات الخلفي.', ['core', 'back']],
  'ليج بريس': ['compound', 'squat', 'اجلس على الجهاز وادفع اللوح بالقدمين حتى تمديد شبه كامل للركبتين من غير قفل كامل.', []],
  'لانجز دمبل': ['compound', 'lunge', 'خطوة للأمام مع دمبلين بجانبك، انزل حتى تصل الركبة الخلفية قريبة من الأرض ثم ارجع.', ['core']],
  'رومانيان ديدليفت': ['compound', 'hinge', 'انحنِ من الحوض مع ركبتين شبه مستقيمتين، أنزل البار قريبًا من الساقين ثم اقف.', ['back', 'core']],
  ...
  'هيب ثرست بار': ['compound', 'hinge', 'ظهرك مسند على بنش والبار فوق الحوض، ادفع الحوض لأعلى حتى استقامة الجسم.', ['core']],
  'كالف رايز واقف': ['isolation', 'extension', 'واقف، ارفع الكعبين لأعلى قدر الإمكان ثم أنزلهم بتحكم.', []],
  'بلغاريان سبليت سكوات': ['compound', 'lunge', 'قدم خلفية مرفوعة على بنش، انزل بالساق الأمامية حتى زاوية قريبة من 90 درجة.', ['core']],
  'ديدليفت تقليدي': ['compound', 'hinge', 'امسك البار من الأرض بظهر مستقيم واقف بدفع الأرض بقدميك حتى الوقوف الكامل.', ['legs', 'core']],
  'سحب أرضي (بار)': ['compound', 'pull', 'انحنِ للأمام بظهر مستقيم واسحب البار نحو أسفل الصدر مع الضغط على لوحي الكتف.', ['arms', 'shoulders']],
  'سحب أرضي دمبل': ['compound', 'pull', 'يد وركبة على البنش، اسحب الدمبل بيدك التانية نحو الخصر.', ['arms', 'shoulders']],
  'بول أب': ['compound', 'pull', 'تعلق من البار بقبضة أوسع من الكتف واسحب جسمك لأعلى حتى يتخطى الذقن البار.', ['arms', 'shoulders']],
  'لات بول داون': ['compound', 'pull', 'اجلس واسحب البار لأسفل نحو أعلى الصدر مع فتح لوحي الكتف.', ['arms', 'shoulders']],
  'سحب كابل جلوس': ['compound', 'pull', 'اجلس واسحب المقبض نحو البطن مع تثبيت الظهر مستقيم.', ['arms', 'shoulders']],
  'تي بار رو': ['compound', 'pull', 'انحنِ للأمام واسحب البار نحو أسفل الصدر بقبضة ثابتة.', ['arms', 'shoulders']],
  'هايبر إكستنشن': ['isolation', 'extension', 'على جهاز الهايبر، انزل الجذع للأمام ثم مدّه لأعلى حتى استقامة الظهر.', ['legs']],
  'أوفرهيد برس بار': ['compound', 'push', 'واقف، ادفع البار من أعلى الكتفين لأعلى الرأس حتى تمديد كامل للذراعين.', ['arms', 'core']],
  'أوفرهيد برس دمبل': ['compound', 'push', 'دمبلين عند الكتفين، ادفعهم لأعلى حتى تمديد شبه كامل.', ['arms', 'core']],
  ...
  'رفرفة خلفية دمبل': ['isolation', 'pull', 'انحنِ للأمام وارفع الدمبلين للجانبين مع التركيز على مؤخرة الكتف.', ['back']],
  'فيس بول': ['isolation', 'pull', 'اسحب الحبل نحو الوجه مع فتح المرفقين للخارج للخلف.', ['back']],
  ...
  'ديبس': ['compound', 'push', 'على البار المتوازي، انزل الجسم بمرفقين قريبين للتركيز على الترايسبس وادفع لأعلى.', ['chest', 'shoulders']],
  'بلانك': ['isolation', 'anti_rotation', 'وضعية الدفع على المرفقين مع تثبيت الجسم مستقيم من الكتف للكاحل.', ['shoulders']],
  'كرانش': ['isolation', 'flexion', 'استلقِ وارفع أعلى الظهر عن الأرض بثني البطن من غير سحب الرقبة.', []],
  'رفع أرجل معلق': ['isolation', 'flexion', 'تعلق من البار وارفع الأرجل لأعلى مع تثبيت الجذع.', ['arms']],
  'روسي تويست': ['isolation', 'rotation', 'اجلس بميل خلفي بسيط ولف الجذع لليمين واليسار بالتبادل.', []],
  'أب ويل': ['compound', 'anti_rotation', 'من الركوع، ادفع العجلة للأمام مع تثبيت البطن ثم ارجع.', ['shoulders', 'back']],
  'جري خفيف': [null, null, 'جري بوتيرة ثابتة ومريحة للتنفس، مناسب للإحماء أو الكارديو الخفيف.', ['legs']],
  'جامبينج جاك': [null, null, 'قفزات بفتح الأرجل والذراعين معًا ثم إغلاقهم بالتبادل.', ['legs', 'shoulders']],
  'بيربيز': ['compound', null, 'انزل لوضع البلانك، ارجع سريعًا، ثم اقفز لأعلى - حركة كارديو مركّبة لكل الجسم.', ['chest', 'legs', 'core']],
  'نط الحبل': [null, null, 'نط بالحبل بوتيرة ثابتة مع قفزات خفيفة على مقدمة القدم.', ['legs', 'shoulders']],
};

const exerciseCount = db.prepare('SELECT COUNT(*) c FROM exercises').get().c;
if (exerciseCount === 0) {
  const insertExercise = db.prepare(
    'INSERT INTO exercises (coach_id, name, muscle_group, equipment, difficulty, exercise_type, movement_pattern, instructions, secondary_muscles) VALUES (NULL, ?, ?, ?, ?, ?, ?, ?, ?)'
  );
  const seedExercises = [
  ...
  const insertMany = db.transaction((rows) => {
    for (const r of rows) {
      const [exType, pattern, instructions, secondaryMuscles] = EXERCISE_CLASSIFICATIONS[r[0]] || [null, null, null, []];
      insertExercise.run(r[0], r[1], r[2], r[3], exType, pattern, instructions, JSON.stringify(secondaryMuscles || []));
    }
  });
  insertMany(seedExercises);
} else {
  // ترقيع القواعد اللي اتزرعت قبل إضافة exercise_type/movement_pattern/
  // instructions/secondary_muscles - تمارين النظام العامة بس (coach_id
  // NULL) واللي لسه فاضية في أي عمود من الأعمدة دي، عشان منلمسش أي
  // تمرين مخصص كوتش عدّله. secondary_muscles قيمته الافتراضية '[]' مش
  // NULL (لأنه NOT NULL)، فبنتأكد من الفراغ عن طريق مقارنته بـ '[]' نفسها.
  const updateClassification = db.prepare(
    `UPDATE exercises SET exercise_type = ?, movement_pattern = ?, instructions = ?, secondary_muscles = ?
     WHERE coach_id IS NULL AND name = ?
       AND (exercise_type IS NULL OR movement_pattern IS NULL OR instructions IS NULL OR secondary_muscles = '[]')`
  );
  const backfill = db.transaction(() => {
    for (const [name, [exType, pattern, instructions, secondaryMuscles]] of Object.entries(EXERCISE_CLASSIFICATIONS)) {
      const secondaryJson = JSON.stringify(secondaryMuscles || []);
      if (exType || pattern || instructions || (secondaryMuscles && secondaryMuscles.length)) {
        updateClassification.run(exType, pattern, instructions, secondaryJson, name);
      }
    }
  });
  backfill();
